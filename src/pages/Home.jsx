...
const SAMPLE_STAYS = [
  ...
  { id: 3, title: 'Riverside Bamboo Cottage',     location: 'Lansdowne, Pauri Garhwal',price: 950, rating: 4.6, reviews: 15, tags: ['Riverside', 'Bird watching'],          host: 'Mohan Das',  eco: false },
  { id: 4, title: 'Deodar Forest Homestay',       location: 'Chakrata, Dehradun',     price: 1250, rating: 4.8, reviews: 29, tags: ['Dense forest', 'Waterfall nearby'],   host: 'Geeta Ji',   eco: true  },
  { id: 5, title: 'Old Tehri Heritage Bungalow',  location: 'Tehri, Uttarakhand',     price: 1600, rating: 5.0, reviews: 12, tags: ['Heritage', 'Lake view', 'Kayaking'],  host: 'Arjun Singh', eco: false },
  { id: 6, title: 'Kumaoni Village Farmstay',     location: 'Binsar, Almora',         price: 800,  rating: 4.5, reviews: 44, tags: ['Farm stay', 'Village walk', 'Organic'],host: 'Rekha Ji',   eco: true  },
]
